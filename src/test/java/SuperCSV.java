...
//            System.out.println("*****************************************************************************************");
            ...
            ICsvMapReader mapReaderEsperado = new CsvMapReader(new FileReader("/home/auxi/Documentos/usuarios_import.csv"), (new CsvPreference.Builder('"', 59, "\r\n")).build());
...
//                if (listmapRespuesta.contains(customerMapEsperado)) {
//                    System.out.println("El usuario esperado " + customerMapEsperado.get("Nombres") + " SI está contenido en la respuesta");
//                } else {
//                    System.out.println("El usuario esperado " + customerMapEsperado.get("Nombres") + " NO está contenido en la respuesta");
//                }
            }
